...
complex application with template, static files and configuration bits.

Of course, Dancer is much much more than that tip of the iceberg we've just
...
chapter focused on the power of route handlers.
